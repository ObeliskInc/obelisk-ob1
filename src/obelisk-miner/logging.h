...
//NOTE: obe_log will write everything to the log file
#define applog(prio, fmt, ...)                                           \
    do {                                                                 \
...
#define applogsiz(prio, _SIZ, fmt, ...)                                  \
    do {                                                                 \
        if (opt_debug || prio != LOG_DEBUG) {                            \
            if (use_syslog || opt_log_output || prio <= opt_log_level) { \
                char tmp42[_SIZ];                                        \
